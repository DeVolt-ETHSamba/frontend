...
const BuyPower: NextPage = () => {
    ...
    //@ts-ignore
    const { writeAsync } = useScaffoldContractWrite<"InputBox", "addInput">({
    ...
    const [averagePrice] = useState(0);
    const [openPopUp, setOpenPopUp] = useState(false);
    const [disableButton] = useState("disabled bg-[#7c7c7c] pointer-events-none");
